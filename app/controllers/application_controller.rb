class ApplicationController < ActionController::Base
  ...
  def configure_permitted_parameters
    ...
    devise_parameter_sanitizer.for(:account_update) << [:username, :role, :stripe_recipient_id, :phone_number, :image_url, :headline, :stripe_customer_id, :stripe_id, :stripe_access_key, :stripe_publishable_key] 
  end
